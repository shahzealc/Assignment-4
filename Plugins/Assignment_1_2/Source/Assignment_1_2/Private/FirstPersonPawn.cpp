...
AFirstPersonPawn::AFirstPersonPawn()
{
	...
	PawnAttributeAsset = LoadObject<UPawnAttributeAsset>(nullptr, TEXT("/Script/Assignment_1_2.PawnAttributeAsset'/Game/Assignment2/DataAssets/FirstPersonAssert.FirstPersonAssert'"));
}
